...
setUserAdds(response.data))
 ...
 ><h4 className="myAdds_h4"><span
className="myAdds_h4_span">Mina Annonser</span></h4></div>
...
setUserAdds(response.data))
 ...
 ><h4 className="settings_h4"><span
className="settings_h4_span">Inställningar</span></h4></div>
 ...
 ><h4 className="newAdd_h4"><span
className="newAdd_h4_span"> Lägg till annons</span></h4></div>
 </div>
 ...
 <input className="img_input" id="addImg_input" type="file"
name='file' placeholder="Ladda upp en bild"
onChange={(e)=>{setImg(e.target.files[0])}}></input>

 {loading? (<h3>Loading...</h3>):null}
 {/* <Image style={{width:"300px"}} cloudName="bexryd"
publicId="v1661432762/Hantverkare/osttz434t7pbelwvupqc.jpg"/> */}
...
setHeading(e.target.value)}></input>
...
*/}
 ...
 <div className='popUp'>
 <div>
 <p className="popUp--close" onClick={handlePopUp} >&times;
</p>
 ...
 <img className="popUp--img change_img" src={imageUrl}></
img>
 <div>
 <p>{category}</p>
 <h3 className="popUp--title">{changeTitlePopup}</h3>
 <p className="popUp--description">{changeDescriptionPopup}
</p>
 <p>{emailPopup}</p>
 </div>
...
onChange={(e)=>{setChangeTitlePopup(e.target.value)

 }}/>


 <textarea
 placeholder="Beskrivning" onChange={(e) =>
setChangeDescriptionPopup(e.target.value)} ></textarea>
